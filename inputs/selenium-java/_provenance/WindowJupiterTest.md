# Provenance: WindowJupiterTest.java

## Source
- **Upstream:** [bonigarcia/selenium-webdriver-java](https://github.com/bonigarcia/selenium-webdriver-java)
- **License:** Apache-2.0
- **Path in upstream:** `selenium-webdriver-junit5/src/test/java/io/github/bonigarcia/webdriver/jupiter/ch04/window/WindowJupiterTest.java`
- **Fetched on:** 2026-06-09 via `gh api repos/bonigarcia/selenium-webdriver-java/contents/...`

## Topic
- **Anti-pattern domain:** Window
- **Summary:** Browser window size + position + maximize (ch04/window)
...
- Stage 2 fires, emits `outputs/tests/windowjupitertest.spec.ts` (kebab-case per migration-rules.md)

# Provenance: ScreenshotPngJupiterTest.java

## Source
- **Upstream:** [bonigarcia/selenium-webdriver-java](https://github.com/bonigarcia/selenium-webdriver-java)
- **License:** Apache-2.0
- **Path in upstream:** `selenium-webdriver-junit5/src/test/java/io/github/bonigarcia/webdriver/jupiter/ch04/screenshots/ScreenshotPngJupiterTest.java`
- **Fetched on:** 2026-06-09 via `gh api repos/bonigarcia/selenium-webdriver-java/contents/...`

## Topic
- **Anti-pattern domain:** Screenshots
- **Summary:** Full-page PNG screenshot via TakesScreenshot (ch04/screenshots)
...
- Stage 2 fires, emits `outputs/tests/screenshotpngjupitertest.spec.ts` (kebab-case per migration-rules.md)
